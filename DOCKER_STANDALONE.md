...
| `VNC_PASSWORD` | `familylink` | Password for noVNC browser access |
...
1. Open noVNC in your browser: `http://localhost:6080/vnc.html`
...
services:
  ...
  familylink-auth:
    ...
    environment:
      ...
      - VNC_PASSWORD=your_secure_password  # noVNC access password
    restart: unless-stopped
    healthcheck:
